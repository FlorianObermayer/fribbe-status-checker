...
# SQLite database URL. Defaults to a file in the LOCAL_DATA_PATH directory.
...
def load() -> None:
    ...
    g["DATABASE_URL"] = os.environ.get("DATABASE_URL") or f"sqlite:///{g['LOCAL_DATA_PATH']}/fribbe.db"
    _log()
